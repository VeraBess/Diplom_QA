...
#### 1.2.4.29 Одна цифра в поле "CVC/CVV"
*Шаги:*
- В поле "Номер карты" ввести - 4444 4444 4444 4441
- в поле "Месяц" ввести - 07
- В поле "Год" ввести - 25
...
*Ожидаемый результат:* Отправка формы не происходит. Под полем "Владелец" появляется красная надпись "Неверный формат"
#### 1.2.4.30 Четыре цифры в поле "CVC/CVV"
*Шаги:*
- В поле "Номер карты" ввести - 4444 4444 4444 4441
- в поле "Месяц" ввести - 07
- В поле "Год" ввести - 25
...
#### 1.2.4.31 Ввод букв в поле "CVC/CVV"
*Шаги:*
- В поле "Номер карты" ввести - 4444 4444 4444 4441
- в поле "Месяц" ввести - 07
- В поле "Год" ввести - 25
...
#### 1.2.4.32 Ввод спец.символов в поле "CVC/CVV"
*Шаги:*
- В поле "Номер карты" ввести - 4444 4444 4444 4441
- в поле "Месяц" ввести - 07
- В поле "Год" ввести - 25
...
- Нарушение изоляции тестов - результаты тестов сохраняются в базе данных и могут влиять на выполнение следующих тестов. необходимо настраивать очистку базы данных после выполнения тестов.
